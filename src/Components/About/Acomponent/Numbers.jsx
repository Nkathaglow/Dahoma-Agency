...
function Numbers() {
  return (
    <div className="bg-white flex flex-col items-center pt-4">
              ...
              <div className="flex flex-col items-stretch my-auto max-md:max-w-full max-md:mt-10">
                 <div className="text-neutral-900 text-5xl font-semibold leading-[56px] tracking-tighter max-md:max-w-full max-md:text-4xl max-md:leading-[52px]">
                  ...
                  <div className="text-zinc-600 text-lg font-medium leading-8 mt-12 max-md:max-w-full max-md:mt-10">
                    ...
                    transcend borders, embodying the essence of diverse cultures while
                    leaving a lasting impact that's universally recognized.
                  </div>
                </div>
              </div>{" "}
                ...
                <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                  <div className="flex flex-col items-stretch w-[36%] max-md:w-full max-md:ml-0">
                    <img
                        ...
                        className="aspect-[1.24] object-cover object-center w-full h-full box-border min-h-[50px] min-w-[50px] overflow-hidden mt-30"
                  />
                  </div>
      ...
      <div className="bg-slate-200 self-stretch flex w-full justify-between gap-5 mt-32 py-12 items-end max-md:max-w-full max-md:flex-wrap max-md:mt-10">
        <div className="bg-amber-500 flex basis-[0%] flex-col justify-center items-stretch mt-44 max-md:mt-10">
          <img
            loading="lazy"
            srcSet="../src/assets/team1.png"
            className="aspect-[0.42] object-contain object-center w-full overflow-hidden"
          />
        </div>
        ...
        <div className="flex grow basis-[0%] flex-col items-stretch self-start max-md:max-w-full">
          <div className="flex w-full items-stretch justify-between gap-5 px-5 max-md:max-w-full max-md:flex-wrap max-md:justify-center">
            <div className="self-center flex basis-[0%] flex-col items-stretch my-auto">
              ...
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/9e1ffc4ff30da629f95048b50095658f2e62bbc017ec45f3c71aebdf902e951e?apiKey=5e9216a8905e4b3dbda114fe063d2097&"
              ...
              <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                <div className="flex flex-col items-stretch w-[18%] max-md:w-full max-md:ml-0">
                  <div className="flex grow flex-col items-stretch max-md:mt-10">
                    ...
                    <div className="text-white text-base font-medium whitespace-nowrap mt-16 max-md:mt-10">
                      Services
                    </div>
